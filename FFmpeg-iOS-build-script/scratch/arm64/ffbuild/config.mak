...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=darwin --arch=arm64 --cc='xcrun -sdk iphoneos clang' --as='gas-preprocessor.pl -arch aarch64 -- xcrun -sdk iphoneos clang' --enable-cross-compile --disable-debug --disable-programs --disable-doc --enable-pic --disable-audiotoolbox --extra-cflags='-arch arm64 -mios-version-min=13.0 -fembed-bitcode' --extra-ldflags='-arch arm64 -mios-version-min=13.0 -fembed-bitcode' --prefix=/Users/eric/Developer/code/GeminiPlayer/FFmpeg-iOS-build-script/thin/arm64
prefix=/Users/eric/Developer/code/GeminiPlayer/FFmpeg-iOS-build-script/thin/arm64
...
CC_IDENT=Apple clang version 14.0.3 (clang-1403.0.22.14.1)
ARCH=aarch64
INTRINSICS=neon
EXTERN_PREFIX=_
...
CFLAGS=  -arch arm64 -mios-version-min=13.0 -fembed-bitcode -std=c11 -Werror=partial-availability -fomit-frame-pointer -fPIC -pthread  -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -O3 -fno-math-errno -fno-signed-zeros -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCCFLAGS=  
ASFLAGS=  -arch arm64 -mios-version-min=13.0 -fembed-bitcode -fPIC -Qunused-arguments
...
WINDRES=windres
DOXYGEN=doxygen
LDFLAGS= -arch arm64 -mios-version-min=13.0 -fembed-bitcode  -Wl,-dynamic,-search_paths_first -Qunused-arguments
LDEXEFLAGS=
LDSOFLAGS=
